...
export function d2t(time, shorten) {
  ...
  if (shorten) {
    if (displayValue.startsWith('00:00:')) displayValue = displayValue.substring(6, displayValue.length);
    else if (displayValue.startsWith('00:')) displayValue = displayValue.substring(3, displayValue.length);
  }
...
export function formatTime(time) {
  ...
  if (displayValue.startsWith('00:')) displayValue = displayValue.substring(3, displayValue.length);
  return displayValue.substring(0, displayValue.length - 1);
}
...
const firstRunStoreKey = 'firstRun';

export function isFirstRun() {
  return localStorage.getItem(firstRunStoreKey) === 'yes';
}

export function setFirstRunCompleted() {
  localStorage.setItem(firstRunStoreKey, 'yes');
}
