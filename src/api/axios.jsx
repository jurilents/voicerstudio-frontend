        ...
        if (!error) {
            ...
            toast.error(
                <>
                    ...
                    Please, check your internet connection or wait until the server is up and running again.
                    <em style={{ display: 'inline-block', marginTop: '15px' }}>
                        If you see this message for a long time, please contact support:
                    </em>
                    <br />
                    <a href={'https://t.me/' + settings.supportTelegram} style={{ color: 'var(--c-primary-light)' }}>
